...
- `GET /api/tasks/{task_id}/logs`：读取已持久化的 lifecycle task 日志、heartbeat、artifacts、stdout/stderr 和 `metadata.artifact_manifest`。
