...
func DefaultCatalog() Catalog {
	return NewCatalog([]ToolSpec{
		...
		},
		{
			...
			Risk:              RiskMedium,
			AllowedParamKeys:  []string{"dataset_id", "target_task", "model_family", "annotation_version", "split_config", "output_registry", "dry_run", "execution_recipe"},
		...
		},
		{
			...
			Risk:              RiskMedium,
			AllowedParamKeys:  []string{"dataset_id", "model_id", "split", "metrics", "save_visuals", "failure_mining", "dry_run", "execution_recipe"},
		...
		},
		{
			...
			Risk:              RiskMedium,
			AllowedParamKeys:  []string{"model_id", "model_version", "target", "runtime", "replicas", "strategy", "resource_class", "rollback_policy", "dry_run", "execution_recipe"},
